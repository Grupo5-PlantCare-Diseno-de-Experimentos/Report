...
La Matriz de Evaluación Ética y de Impacto permite al equipo de **PlantCare** reconocer sus responsabilidades éticas y profesionales como ingenieros de software, y emitir juicios informados sobre los posibles efectos colaterales de nuestra solución IoT y web en el entorno social, económico, ambiental y global. De esta manera, evitamos el enfoque netamente instrumental del desarrollo técnico y asumimos un compromiso activo con el bienestar y la seguridad de nuestros usuarios y la comunidad.
...
| :--- | :--- | :--- | :--- |
| **1. Salud Pública y Seguridad** | **Negativo:** El uso de sensores eléctricos en tierra húmeda y sistemas de riego automáticos o notificaciones push constantes puede inducir a riesgos de cortocircuito o fatiga por alertas (ansiedad) en usuarios vulnerables como adultos mayores. Si hay cables expuestos en macetas o si la batería de los sensores de litio se sobrecalienta o desecha incorrectamente, podría causar accidentes domésticos.<br>**Positivo:** Fomenta un entorno saludable en el hogar (purificación de aire por plantas, reducción de estrés). | **Afectados:** Usuarios finales, en especial niños, mascotas y adultos mayores con menor destreza física. El riesgo físico potencial es de magnitud moderada-baja si se usa voltaje doméstico bajo (USB/baterías), pero la fatiga por alertas es alta si no se controla. | **Acciones:** Uso de sensores herméticos de bajo voltaje (3.3V/5V) con aislamiento IP65. Implementación de límites a la frecuencia de notificaciones push (máximo una notificación diaria de riego no urgente, y consolidación de alertas). Guías explícitas de instalación segura y manejo de baterías. |
| **2. Inclusión y Accesibilidad** | **Negativo:** La aplicación web o móvil puede no ser accesible para adultos mayores (problemas de visión, destreza motriz fina) o requerir smartphones de última generación con alto consumo de datos.<br>**Positivo:** Permite la participación activa de adultos mayores en actividades terapéuticas y de ocio estimulantes. | **Afectados:** Adultos mayores y personas con capacidades visuales reducidas. | **Acciones:** Cumplimiento con las pautas de accesibilidad web (WCAG 2.1 AA): tamaño de fuente ajustable, contraste elevado (mínimo 4.5:1), soporte completo para lectores de pantalla y modo oscuro adaptado. Interfaz simplificada con botones de gran tamaño para el segmento de la tercera edad. |
| **3. Impacto Social y Cultural** | **Negativo:** Desapego de las actividades de cuidado natural de las plantas al automatizar/digitalizar el monitoreo. Puede generar frustración o sensación de fracaso si la planta muere a pesar de usar la app.<br>**Positivo:** Fomenta la responsabilidad individual y familiar por el cuidado de seres vivos, y el intercambio cultural sobre botánica urbana en comunidades locales. | **Afectados:** Familias en entornos urbanos y aficionados de plantas. | **Acciones:** Diseñar un flujo de aprendizaje y motivación (módulo de lecciones y racha de logros no punitivos) que reconozca el esfuerzo y enseñe que la muerte de una planta es parte del aprendizaje natural, promoviendo metas colaborativas entre miembros del hogar en lugar de gamificación estresante. |
| **4. Impacto Económico** | **Negativo:** El costo de suscripción y de los sensores IoT puede excluir a hogares de menores ingresos. Suscripción premium confusa o cobro excesivo por maceta extra que disuada a pequeños aficionados.<br>**Positivo:** Ahorro económico al evitar la compra recurrente de nuevas plantas para reemplazar las muertas y optimización en el consumo de agua. | **Afectados:** Consumidores locales y pequeños viveros o comercios de plantas que dependen de que la gente siga comprando plantas. | **Acciones:** Ofrecer un plan gratuito que permita el monitoreo manual (sin sensores IoT, solo recordatorios por calendario basados en la especie) y un plan de hardware básico económico. Algoritmo de recomendación que promueva la compra de plantas en viveros locales pequeños y medianos para reactivar la economía local. |
| **5. Impacto Ambiental (Antrópico)** | **Negativo:** Generación de residuos electrónicos (e-waste) debido al desecho de sensores IoT dañados o baterías de litio. Consumo de energía por la transmisión constante de datos de sensores y servidores en la nube.<br>**Positivo:** Optimización del recurso hídrico, reduciendo el desperdicio de agua en el riego y previniendo la degradación del suelo de las macetas. | **Afectados:** El ecosistema local y la huella ecológica global. | **Acciones:** Uso de sensores con materiales reciclables o biodegradables en la medida de lo posible, diseño de circuitos de ultra bajo consumo que prolonguen la vida de la batería (modo deep sleep), y optimización del código del servidor (Supabase) para procesar solo lecturas periódicas significativas (ej. cada 4 horas en lugar de cada minuto). Campaña de reciclaje de sensores al final de su vida útil. |
| **6. Enfoque Global** | **Negativo:** Uso de servicios en la nube internacionales (como Supabase, Vercel, Discord Webhooks) que exportan datos de comportamiento de los usuarios (patrones de presencia en el hogar según el riego) a servidores regulados por leyes extranjeras. | **Afectados:** Privacidad de los usuarios en entornos globales. | **Acciones:** Minimizar los datos personales recopilados (solo correo electrónico y datos anónimos de humedad). Encriptación de datos sensibles en tránsito y en reposo. Configuración de políticas de privacidad alineadas con estándares estrictos como GDPR. |
| **7. Revelación de Peligros y Responsabilidad** | **Riesgo:** Si descubrimos que los datos de humedad o el estado de los sensores pueden ser alterados de forma maliciosa por fallos de seguridad (lo que podría llevar a que se ahogue o seque una planta valiosa o a que se use de puente para atacar la red local del usuario). | **Afectados:** Integridad de la red doméstica y del patrimonio vegetal del usuario. | **Acciones:** Aceptar la responsabilidad profesional según el Código de Ética de Ingeniería de Software. Si se detecta un peligro en la API o el hardware, se comunicará de inmediato de forma transparente a los usuarios mediante alertas in-app o correo electrónico, suspendiendo temporalmente el servicio de control automático si existiera riesgo físico o de seguridad informática grave hasta implementar un parche correctivo. |
