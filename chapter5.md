...
En esta sección se detalla la configuración del entorno de desarrollo de software utilizada por el equipo, incluyendo las herramientas tecnológicas requeridas para cada fase del ciclo de vida del producto IoT. Se especifican sus nombres, propósito dentro del proyecto y rutas de referencia o descarga, organizadas según las actividades de Project Management, Requirements Management, Product UX/UI Design, Software Development, Software Testing, Software Deployment y Software Documentation.
...
| Nombre del Producto | Propósito                                                 | Ruta de referencia o de descarga                                |
|---------------------|-----------------------------------------------------------|-----------------------------------------------------------------|
| render y github      | Para realizar el despliegue de nuestra Landing Page.   y web app     | [https://render.com/](https://render.com/)           
...
| Organización | URL |
|-|-|
|ASI0572-2520-3443-Grupo-2-IoTeam|https://github.com/Grupo5-PlantCare-Diseno-de-Experimentos|
...
| Repositorio | URL |
|-|-|
| FrontendWeb|https://github.com/Grupo5-PlantCare-Diseno-de-Experimentos/Plant-Care-Web| 
|LandingPage|https://github.com/ASI0572-2520-3443-Grupo-2-IoTeam/|
|Documentation|hhttps://github.com/Grupo5-PlantCare-Diseno-de-Experimentos/Report |
...
#### vue
- se aplico al front end 
- se uso DDD
- clean code para un mejor codigo

#### supabase

- auntenticacion segura y rapida
- mas rapido que un backend
- mas dinamico y visual
...
|-----------------------------|-----------------------|----------------------------------------|
| **Frontend Web (SPA con Vue.js)** | **supabase** | El frontend se construye con `npm run build` y los archivos estáticos generados se despliegan automáticamente mediante CI/CD desde GitHub Actions hacia **supabase**. |
| **Landing Page (Informativa)** | **githubl** | La landing page del producto se despliega en **Vercel**, enlazada directamente al repositorio del proyecto. Desde ella se podrá descargar el APK de la aplicación móvil. |
...
| **Prepared By**                  | IoTeam                                                                                                             |
| **Attendees (to planning meeting)** |todos los integrantes del grupo|
| **Sprint Goal & User Stories**   | landing oague and web app                                                         |
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Title</th>
            <td>Description</th>
            <td>Estimation (Hours)</th>
            <td>Assigned To</th>
            <td>Status (To-do / In-Process / To-Review / Done)</th>
        </tr>
        <!-- Fila de separación -->
        <tr>
...
<a href="https://ibb.co/GfvnMHNS"><img src="https://i.ibb.co/KcjbsKSv/Captura-de-pantalla-2026-04-28-144632.png" alt="Captura-de-pantalla-2026-04-28-144632" border="0"></a>
[![image.png](https://i.postimg.cc/CKfVHRVm/image.png)](https://postimg.cc/t1yf9CJx)
...
<a href="https://ibb.co/XxPgDpYL"><img src="https://i.ibb.co/JjT4q23t/Captura-de-pantalla-2026-04-28-144923.png" alt="Captura-de-pantalla-2026-04-28-144923" border="0"></a>
